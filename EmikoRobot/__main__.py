...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an Cat-theme management bot [✨](https://telegra.ph/file/9cfb80c99b33676aba7c0.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    [
        InlineKeyboardButton(text="About Kitty Robot", callback_data="emiko_"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="➗ Add Kitty To Your Group ➗", url="t.me/KittyXRobot?startgroup=new"),
    ],
]
...
EMI_IMG = "https://telegra.ph/file/f45590e13e39bb2c23993.jpg"
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            text="๏ I'm *Kitty*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n Click on button bellow to get basic help for KittyRobot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Source Code", url="https://github.com/dipvyash/EmikoRobot"),
                 ],
                 [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="htps://t.me/luv_love_town"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/Animes_Channels"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
        ...
        query.message.edit_text(
            ...
            "\nHere Developers Making And Give Inspiration For Made The KITTYRobot",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
